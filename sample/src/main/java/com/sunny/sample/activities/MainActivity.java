...
import com.sunny.sample.activities.user.LoginActivity;
import com.sunny.sample.activities.user.RegisterActivity;
...
//		Router.builder(this).host("UserInfoActivity").interceptor(
//				new LoginInterceptor(this)).start();
//		Router.builder(this).packageName("com.sunny.sample.activities.user").host(
